Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :git => 'https://github.com/helpscout/beacon-ios-sdk.git', :tag => "0.44" }
  ...
  s.frameworks = 'UIKit', 'Photos', 'UserNotifications', 'WebKit', 'MobileCoreServices', 'SafariServices'
